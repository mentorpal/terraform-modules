...
This module is a fork of [terraform-aws-notify-slack](https://github.com/terraform-aws-modules/terraform-aws-notify-slack),
version 4.x (5.x requires aws 4.x), with an added support for CodePipeline events.
